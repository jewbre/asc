...
/**
 * This is the base-model class for table "shoppingCategory".
 *
 * @property integer $id
 ...
 */
abstract class ShoppingCategory extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\common\models\ShoppingItem::className(), ['shoppingCategoryID' => 'id']);
    }
